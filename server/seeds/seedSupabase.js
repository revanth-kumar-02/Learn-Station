...
const categoriesConfig = {
  ...
  ai: {
    ...
    tracks: [
      { slug: 'prompt-eng', name: 'Prompt Engineering', icon: 'cpu', color: 'hsl(262, 83%, 58%)', lessons: ['System Directives', 'Few-Shot prompting', 'Chain of Thought (CoT)', 'Prompt templates design', 'Output formatting JSON', 'Zero-shot learning', 'Role prompting tactics', 'Handling hallucinations', 'Prompt security injections', 'Dynamic context prompts', 'Iterative prompt tuning', 'Prompts size tokens limit'] },
      { slug: 'nlp', name: 'Natural Language Processing', icon: 'cpu', color: 'hsl(199, 89%, 48%)', lessons: ['NLP Tokenization', 'Stopwords & Stemming', 'TF-IDF Text Vectors', 'Word Embeddings concept', 'Recurrent Neural Nets', 'Transformers architecture', 'Attention Mechanism', 'Sentiment Analysis NLP', 'Named Entity Recog NER', 'Text Summarization models', 'Machine Translation seq2seq', 'BERT fine-tuning'] },
      { slug: 'computer-vision', name: 'Computer Vision', icon: 'cpu', color: 'hsl(346, 77%, 50%)', lessons: ['Image Arrays pixels', 'Color spaces RGB/HSV', 'Kernel Filters blur/edge', 'Image thresholding', 'Convolutional Nets CNN', 'Max Pooling layers', 'Image Classification model', 'Object Detection YOLO', 'Bounding boxes labels', 'Image Segmentation basic', 'Data Augmentation images', 'Transfer Learning ResNet'] },
      { slug: 'generative-ai', name: 'Generative AI', icon: 'cpu', color: 'hsl(38, 92%, 50%)', lessons: ['Generative models concepts', 'Variational Autoencoders VAE', 'Generative Adversarial GANs', 'Transformers for text', 'Diffusion Models images', 'LLM Architectures basic', 'Decoding strategies temp', 'Tokens & Tokenizer pipelines', 'Temperature & Top-P tuning', 'Reinforcement Learning RLHF', 'AI Image prompts', 'Generative safety filters'] },
      { slug: 'llm-engineering', name: 'LLM Engineering', icon: 'cpu', color: 'hsl(262, 83%, 58%)', lessons: ['LLM API Integrations', 'Context Window limits', 'Quantization concepts', 'PEFT & LoRA tuning', 'Model evaluation metrics', 'JSON Mode configurations', 'Instruction tuning rules', 'Retrieval architectures', 'Open-source models deployment', 'Vector Embeddings gen', 'Rate Limits & Caching', 'Fine-tuning datasets prep'] },
      { slug: 'ai-agents', name: 'AI Agents', icon: 'cpu', color: 'hsl(199, 89%, 48%)', lessons: ['Agent ReAct Framework', 'Autonomous Agent loops', 'Agent memory short/long', 'Tool Calling specifications', 'Multi-Agent coordination', 'Agent planning tasks', 'State machines for agents', 'Agent safety guardrails', 'LangChain Agent systems', 'CrewAI multi-agents', 'Agent feedback loop', 'Agent debug techniques'] },
      { slug: 'rag-systems', name: 'RAG Systems', icon: 'cpu', color: 'hsl(142, 71%, 45%)', lessons: ['RAG Pipeline architecture', 'Document Text Chunking', 'Embedding generation APIs', 'Vector Database retrieval', 'Similarity Search cosine', 'Metadata Filtering RAG', 'Query Rewriting methods', 'Reranking retrieval hits', 'Context assembly prompts', 'Evaluating RAG systems', 'Hybrid Search lex/vec', 'RAG database updates'] },
      { slug: 'deep-learning', name: 'Deep Learning', icon: 'cpu', color: 'hsl(346, 77%, 50%)', lessons: ['Perceptrons & Neural Nets', 'Weights & Bias params', 'Activation Functions ReLU', 'Forward Propagation pass', 'Loss Functions cross-ent', 'Backpropagation derivation', 'Gradient Descent optim', 'Overfitting Regularization', 'Batch Normalization', 'Dropout layers optimization', 'Vanishing Gradients issue', 'Adam optimizer tuning'] }
    ]
  },
  devops: {
    title: 'Cloud & DevOps',
    tracks: [
      { slug: 'linux', name: 'Linux Fundamentals', icon: 'server', color: 'hsl(0, 0%, 20%)', lessons: ['Linux File structure', 'Basic Commands ls/cd/pwd', 'File Permissions chmod', 'Processes management ps/kill', 'Pipelines & Redirections', 'Grepping file content grep', 'Bash Scripting variables', 'Bash Conditionals loops', 'Environment PATH vars', 'Package managers apt/yum', 'SSH keygen connections', 'Cron jobs scheduling'] },
      { slug: 'git-github', name: 'Git & GitHub', icon: 'server', color: 'hsl(25, 80%, 50%)', lessons: ['Git Init & Commit', 'Branching & Checkout', 'Git Merges strategies', 'Resolve Merge Conflicts', 'Git Rebase vs Merge', 'Remote Repos push/pull', 'GitHub Pull Requests', 'Git Stash save state', 'Git Reset vs Revert', 'Git Log history commit', 'GitHub Actions basics', 'Forking workflows Git'] },
      { slug: 'docker', name: 'Docker', icon: 'server', color: 'hsl(199, 89%, 48%)', lessons: ['Docker Containers concept', 'Docker Images registry', 'Dockerfile Instructions', 'Docker Volumes persist', 'Port Mapping container', 'Docker Compose files', 'Multi-stage builds file', 'Docker Network bridges', 'Environment parameters', 'Managing container logs', 'Docker Swarm basics', 'Containerizing Node apps'] },
      { slug: 'kubernetes', name: 'Kubernetes', icon: 'server', color: 'hsl(217, 91%, 60%)', lessons: ['Kubernetes Architecture', 'Pods configuration specs', 'K8s Deployments scale', 'Kubernetes Services routing', 'ConfigMaps & Secrets', 'Ingress Controller setup', 'Persistent Volumes claims', 'Kubeclt CLI utility commands', 'Namespaces isolation', 'K8s Liveness probes', 'Rolling Updates rollback', 'Helm Charts basic'] },
      { slug: 'aws', name: 'AWS Cloud', icon: 'server', color: 'hsl(38, 92%, 50%)', lessons: ['AWS Account & IAM security', 'VPC Networks subnets', 'EC2 Virtual Servers', 'S3 Object Storage buckets', 'RDS Relational Databases', 'AWS Lambda serverless', 'Auto Scaling groups ELB', 'CloudWatch Logs alarms', 'AWS CLI usage terminal', 'DynamoDB NoSQL database', 'AWS API Gateway proxy', 'Route 53 Domain Routing'] },
      { slug: 'azure', name: 'Azure Cloud', icon: 'server', color: 'hsl(199, 89%, 48%)', lessons: ['Azure Portals & Directory', 'Virtual Networks VNet', 'Azure Virtual Machines VM', 'Blob Storage accounts', 'SQL Databases in Azure', 'Azure Functions serverless', 'Load Balancers setup', 'Azure Monitor alerts', 'Azure CLI command tasks', 'CosmosDB NoSQL storage', 'App Services deployment', 'Azure Devops pipeline'] },
      { slug: 'google-cloud', name: 'Google Cloud', icon: 'server', color: 'hsl(217, 91%, 60%)', lessons: ['GCP Projects & IAM roles', 'VPC Network subnets GCP', 'Compute Engine VM setups', 'Cloud Storage buckets GCP', 'Cloud SQL database setup', 'Cloud Functions trigger', 'Google Kubernetes Engine', 'Stackdriver monitoring logs', 'gcloud CLI configuration', 'BigQuery analytics engine', 'App Engine deployments', 'Cloud Run containers deployment'] },
      { slug: 'cicd', name: 'CI/CD Pipelines', icon: 'server', color: 'hsl(142, 71%, 45%)', lessons: ['CI/CD Pipeline concepts', 'Build Automation files', 'Unit testing script task', 'Dockerizing pipeline steps', 'GitHub Actions workflows', 'Jenkins Pipelines basic', 'GitLab CI runner configs', 'Artifacts storage setup', 'Environment Staging deploy', 'Deployment strategies blue', 'Secret parameters in CI/CD', 'Automated Rollback scripts'] },
      { slug: 'terraform', name: 'Terraform IaC', icon: 'server', color: 'hsl(262, 83%, 58%)', lessons: ['IaC declarative concept', 'Terraform Providers setup', 'Terraform Variables outputs', 'Declaring Cloud Resources', 'Terraform State file lock', 'Terraform Modules reuse', 'Terraform Plan & Apply', 'State migration backends', 'Terraform Workspace config', 'Resources dependencies dependencies', 'Destroying IaC assets', 'Terraform Cloud basic'] }
    ]
  },
  security: {
    title: 'Cyber Security',
    tracks: [
      { slug: 'security-fundamentals', name: 'Security Fundamentals', icon: 'shield', color: 'hsl(346, 77%, 50%)', lessons: ['CIA Triad concept', 'Threat Vectors taxonomy', 'Symmetric Encryption AES', 'Asymmetric Encryption RSA', 'Hashing functions SHA', 'Access Control models', 'Authentication protocols', 'Social Engineering scams', 'Malware categories virus', 'Firewalls & IDS concepts', 'Risk Assessment basics', 'Security Auditing steps'] },
