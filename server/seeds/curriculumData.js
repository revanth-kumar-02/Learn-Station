...
const lessonsSpecs = {
  ...
  // --- PYTHON (24 lessons) ---
  'python': [
    { slug: 'python-1-1', title: 'Hello Python!', exampleLanguage: 'python', exampleCode: '# First script\nprint("Hello, Python!")', exampleExplanation: 'Prints a message to the console. Python uses print() and ignores comments starting with #.', practiceInstruction: 'Call print to display Hello.', practiceTemplate: '___("Hello")', practiceAnswer: 'print', challenges: [
    ...
    { slug: 'python-1-2', title: 'Variables & Typing', exampleLanguage: 'python', exampleCode: 'name = "Learn Station"\nrating = 5\nis_active = True', exampleExplanation: 'Variables store data. Python is dynamically typed, so type declarations are not required.', practiceInstruction: 'Declare variable rating and set it to 10:', practiceTemplate: '___ = 10', practiceAnswer: 'rating', challenges: [
    ...
    { slug: 'python-1-3', title: 'Arithmetic Operations', exampleLanguage: 'python', exampleCode: 'total = 50 + 10 * 2\nprint(total)', exampleExplanation: 'Supports standard arithmetic (+, -, *, /) and follows math operator precedence rules.', practiceInstruction: 'Use modulus operator to get remainder of 10 divided by 3:', practiceTemplate: 'remainder = 10 ___ 3', practiceAnswer: '%', challenges: [
    ...
    { slug: 'python-1-4', title: 'User Input & Casting', exampleLanguage: 'python', exampleCode: 'age_str = "25"\nage = int(age_str)\nprint(age)', exampleExplanation: 'Convert data types explicitly using int(), float(), and str() casts.', practiceInstruction: 'Cast user input to a float value:', practiceTemplate: 'price = ___("19.99")', practiceAnswer: 'float', challenges: [
    ...
    { slug: 'python-2-1', title: 'Conditionals (If)', exampleLanguage: 'python', exampleCode: 'score = 85\nif score >= 80:\n    print("Passed!")', exampleExplanation: 'Evaluates logical conditions. Blocks are defined using colons and indentation.', practiceInstruction: 'Write the if condition:', practiceTemplate: '___ x > 5:\n    print("Large")', practiceAnswer: 'if', challenges: [
    ...
    { slug: 'python-2-2', title: 'Else & Elif', exampleLanguage: 'python', exampleCode: 'score = 75\nif score >= 90:\n    grade = "A"\nelif score >= 70:\n    grade = "B"\nelse:\n    grade = "F"', exampleExplanation: 'Handles multiple logic paths using elif (else if) and else default cases.', practiceInstruction: 'Complete the else block:', practiceTemplate: 'if active:\n    print("On")\n___:\n    print("Off")', practiceAnswer: 'else', challenges: [
    ...
    { slug: 'python-2-3', title: 'While Loops', exampleLanguage: 'python', exampleCode: 'count = 0\nwhile count < 3:\n    print(count)\n    count = count + 1', exampleExplanation: 'Repeats code blocks as long as a boolean condition remains true.', practiceInstruction: 'Create a loop condition:', practiceTemplate: '___ count < 5:\n    count += 1', practiceAnswer: 'while', challenges: [
    ...
    { slug: 'python-2-4', title: 'For Loops & Range', exampleLanguage: 'python', exampleCode: 'for i in range(3):\n    print(i)', exampleExplanation: 'Iterates over a sequence (such as lists or ranges) for a set number of times.', practiceInstruction: 'Loop over a range of numbers:', practiceTemplate: 'for i ___ range(5):\n    print(i)', practiceAnswer: 'in', challenges: [
    ...
    { slug: 'python-3-1', title: 'Lists Basics', exampleLanguage: 'python', exampleCode: 'fruits = ["apple", "banana"]\nfruits.append("cherry")\nprint(fruits[0])', exampleExplanation: 'Lists are ordered, mutable collections of items. Indexes are 0-indexed.', practiceInstruction: 'Append grape to list:', practiceTemplate: 'items.___("grape")', practiceAnswer: 'append', challenges: [
    ...
    { slug: 'python-3-2', title: 'List Slicing', exampleLanguage: 'python', exampleCode: 'nums = [10, 20, 30, 40]\nprint(nums[1:3])', exampleExplanation: 'Slices lists using [start:stop] notation, extracting subsets of lists.', practiceInstruction: 'Slice list to get first two items:', practiceTemplate: 'sub = nums[0:___]', practiceAnswer: '2', challenges: [
    ...
    { slug: 'python-3-3', title: 'Dictionaries Basics', exampleLanguage: 'python', exampleCode: 'user = {"name": "Alice", "age": 25}\nprint(user["name"])', exampleExplanation: 'Dictionaries store data in unordered, mutable key-value pairs.', practiceInstruction: 'Access age key from dict:', practiceTemplate: "user_age = user['___']", practiceAnswer: 'age', challenges: [
    ...
    { slug: 'python-3-4', title: 'Tuples & Sets', exampleLanguage: 'python', exampleCode: 'coords = (10, 20)\nunique_ids = {1, 2, 2, 3}\nprint(unique_ids)', exampleExplanation: 'Tuples are immutable ordered lists. Sets are unordered collection containing only unique elements.', practiceInstruction: 'Define empty set:', practiceTemplate: 'items = ___()', practiceAnswer: 'set', challenges: [
    ...
    { slug: 'python-4-1', title: 'Defining Functions', exampleLanguage: 'python', exampleCode: 'def greet(name):\n    return f"Hello, {name}!"\nprint(greet("Bob"))', exampleExplanation: 'Creates modular, reusable code blocks using the def keyword.', practiceInstruction: 'Write the function definition keyword:', practiceTemplate: '___ calculate_sum(a, b):', practiceAnswer: 'def', challenges: [
    ...
    { slug: 'python-4-2', title: 'Return Statement', exampleLanguage: 'python', exampleCode: 'def multiply(a, b):\n    return a * b\nresult = multiply(4, 5)', exampleExplanation: 'Sends values back to the function caller using the return keyword.', practiceInstruction: 'Return result value:', practiceTemplate: 'def double(x):\n    ___ x * 2', practiceAnswer: 'return', challenges: [
    ...
    { slug: 'python-4-3', title: 'Default Parameters', exampleLanguage: 'python', exampleCode: 'def greet(name="Guest"):\n    print(f"Hello, {name}")\ngreet()', exampleExplanation: 'Defines fallback default values for function parameters, making arguments optional.', practiceInstruction: 'Define role default value as guest:', practiceTemplate: 'def login(user, role="___"):', practiceAnswer: 'guest', challenges: [
    ...
    { slug: 'python-4-4', title: 'Variables Scope', exampleLanguage: 'python', exampleCode: 'x = 10\ndef print_val():\n    global x\n    x = 20\nprint_val()', exampleExplanation: 'Differentiates local scope variables (inside functions) from global scope variables (outside functions).', practiceInstruction: 'Declare variable scope as global:', practiceTemplate: 'def set_x():\n    ___ x\n    x = 100', practiceAnswer: 'global', challenges: [
    ...
    { slug: 'python-5-1', title: 'Reading Files', exampleLanguage: 'python', exampleCode: 'with open("data.txt", "r") as file:\n    content = file.read()\n    print(content)', exampleExplanation: 'Opens system files for reading. The with statement automatically handles file close cleanup.', practiceInstruction: 'Open file for reading:', practiceTemplate: 'with open("log.txt", "___") as f:', practiceAnswer: 'r', challenges: [
    ...
    { slug: 'python-5-2', title: 'Writing Files', exampleLanguage: 'python', exampleCode: 'with open("output.txt", "w") as file:\n    file.write("Hello, World!")', exampleExplanation: 'Opens and writes data to system files. "w" mode overwrites the file; "a" mode appends to it.', practiceInstruction: 'Open file in write mode:', practiceTemplate: 'with open("out.txt", "___") as f:', practiceAnswer: 'w', challenges: [
    ...
    { slug: 'python-5-3', title: 'Handling Exceptions', exampleLanguage: 'python', exampleCode: 'try:\n    num = 10 / 0\nexcept ZeroDivisionError:\n    print("Cannot divide by zero!")', exampleExplanation: 'Prevents runtime crashes by catching execution errors inside try-except blocks.', practiceInstruction: 'Catch execution exceptions:', practiceTemplate: 'try:\n    x = 1/0\n___ ZeroDivisionError:', practiceAnswer: 'except', challenges: [
    ...
    { slug: 'python-5-4', title: 'Finally Block', exampleLanguage: 'python', exampleCode: 'try:\n    f = open("data.txt")\nexcept:\n    print("Error")\nfinally:\n    print("Cleanup")', exampleExplanation: 'The finally block always executes after try/except blocks, regardless of whether an exception occurred.', practiceInstruction: 'Write the final clause:', practiceTemplate: 'try:\n    run()\n___:\n    cleanup()', practiceAnswer: 'finally', challenges: [
    ...
    { slug: 'python-6-1', title: 'Classes & Objects', exampleLanguage: 'python', exampleCode: 'class User:\n    pass\n\nalice = User()\nprint(type(alice))', exampleExplanation: 'Classes act as blueprints for creating custom objects (instances) in Python.', practiceInstruction: 'Declare class User:', practiceTemplate: '___ User:\n    pass', practiceAnswer: 'class', challenges: [
    ...
    { slug: 'python-6-2', title: 'Constructors & self', exampleLanguage: 'python', exampleCode: 'class Product:\n    def __init__(self, name):\n        self.name = name\np1 = Product("Laptop")', exampleExplanation: 'Constructors initialize object properties. The __init__ method runs automatically when instantiating classes.', practiceInstruction: 'Define constructor method:', practiceTemplate: 'def ___ (self, price):', practiceAnswer: '__init__', challenges: [
    ...
    { slug: 'python-6-3', title: 'Class inheritance', exampleLanguage: 'python', exampleCode: 'class Animal:\n    def speak(self):\n        print("Sound")\n\nclass Dog(Animal):\n    pass', exampleExplanation: 'Inheritance allows a child class to inherit attributes and methods from a parent class.', practiceInstruction: 'Inherit from Animal:', practiceTemplate: 'class Cat(___):', practiceAnswer: 'Animal', challenges: [
    ...
    { slug: 'python-6-4', title: 'Polymorphism', exampleLanguage: 'python', exampleCode: 'class Cat:\n    def speak(self): return "Meow"\n\nclass Dog:\n    def speak(self): return "Woof"', exampleExplanation: 'Polymorphism allows different classes to implement methods with the same name, behaving differently depending on the object.', practiceInstruction: 'Override sound in child class:', practiceTemplate: 'class Dog(Animal):\n    def speak(self):\n        return "___"', practiceAnswer: 'woof', challenges: [
  ...
  'webdev': [
    ...
    { slug: 'webdev-5-1', title: 'JS Variable Declarations', exampleLanguage: 'javascript', exampleCode: 'let name = "Bob";\nconst pi = 3.14;\nconsole.log(name);', exampleExplanation: 'Stores variables in JavaScript. Use const for constants that cannot be reassigned, and let for mutable variables.', practiceInstruction: 'Declare mutable variable counter:', practiceTemplate: '___ counter = 0;', practiceAnswer: 'let', challenges: [
    ...
    { slug: 'webdev-5-2', title: 'JS Event Listeners', exampleLanguage: 'javascript', exampleCode: 'const btn = document.querySelector("#btn");\nbtn.addEventListener("click", () => {\n  console.log("Clicked!");\n});', exampleExplanation: 'Listens for browser interactions (like clicks or key presses) and executes callback handlers.', practiceInstruction: 'Listen for button click events:', practiceTemplate: 'btn.addEventListener("___", () => {});', practiceAnswer: 'click', challenges: [
    ...
    { slug: 'webdev-5-3', title: 'DOM Query Selectors', exampleLanguage: 'javascript', exampleCode: 'const title = document.querySelector(".title");\ntitle.textContent = "New Title";', exampleExplanation: 'Queries HTML elements from the DOM tree using CSS selector queries.', practiceInstruction: 'Query main title heading:', practiceTemplate: 'const h1 = document.___("h1");', practiceAnswer: 'querySelector', challenges: [
    ...
    { slug: 'webdev-5-4', title: 'Modifying DOM Text', exampleLanguage: 'javascript', exampleCode: 'const el = document.querySelector("p");\nel.textContent = "Hello!";', exampleExplanation: 'Updates the text inside HTML elements by modifying their textContent property.', practiceInstruction: 'Change element textContent:', practiceTemplate: 'el.___ = "Success";', practiceAnswer: 'textContent', challenges: [
    ...
    { slug: 'webdev-6-1', title: 'Creating Elements', exampleLanguage: 'javascript', exampleCode: 'const div = document.createElement("div");\ndiv.textContent = "Nested";\ndocument.body.appendChild(div);', exampleExplanation: 'Creates new HTML elements in memory using createElement(), then inserts them into the document structure using appendChild().', practiceInstruction: 'Create a paragraph element:', practiceTemplate: 'const p = document.___("p");', practiceAnswer: 'createElement', challenges: [
    ...
    { slug: 'webdev-6-2', title: 'Modifying CSS Classes', exampleLanguage: 'javascript', exampleCode: 'const card = document.querySelector(".card");\ncard.classList.add("active");', exampleExplanation: 'Adds, removes, or toggles CSS class names on elements using classList properties.', practiceInstruction: 'Add class active to element:', practiceTemplate: 'card.classList.___("active");', practiceAnswer: 'add', challenges: [
    ...
    { slug: 'webdev-6-3', title: 'Async JS & Promises', exampleLanguage: 'javascript', exampleCode: 'const task = new Promise(resolve => {\n  setTimeout(() => resolve("Done"), 100);\n});', exampleExplanation: 'Promises handle asynchronous operations in JavaScript, transitioning from pending to fulfilled.', practiceInstruction: 'Instantiate new Promise:', practiceTemplate: 'const p = ___ Promise((resolve) => {});', practiceAnswer: 'new', challenges: [
    ...
    { slug: 'webdev-6-4', title: 'Fetching API Data', exampleLanguage: 'javascript', exampleCode: 'fetch("https://api.example.com/data")\n  .then(res => res.json())\n  .then(data => console.log(data));', exampleExplanation: 'Retrieves external data asynchronously. fetch() returns a Promise resolving to a Response object.', practiceInstruction: 'Call fetch API:', practiceTemplate: '___("https://api.com/users")', practiceAnswer: 'fetch', challenges: [
  ...
  // --- JAVA (24 lessons) ---
  'java': [
    { slug: 'java-1-1', title: 'Java Basics', exampleLanguage: 'java', exampleCode: 'public class Main {\n  public static void main(String[] args) {\n    System.out.println("Hello, Java!");\n  }\n}', exampleExplanation: 'Java is class-based. Every application runs from a public static void main method.', practiceInstruction: 'Complete the main print statement:', practiceTemplate: 'System.out.___ ("Hello");', practiceAnswer: 'println', challenges: [
    ...
    { slug: 'java-1-2', title: 'Explicit Variable Types', exampleLanguage: 'java', exampleCode: 'int age = 25;\ndouble price = 19.99;\nboolean active = true;', exampleExplanation: 'Java is statically typed, meaning you must declare variable types explicitly before using them.', practiceInstruction: 'Declare float pricing variable type:', practiceTemplate: '___ cost = 19.99;', practiceAnswer: 'double', challenges: [
    ...
    { slug: 'java-1-3', title: 'Java Arithmetic', exampleLanguage: 'java', exampleCode: 'int total = 10 + 5 * 2;\nSystem.out.println(total);', exampleExplanation: 'Supports standard arithmetic (+, -, *, /) and follows operator precedence rules.', practiceInstruction: 'Perform division in Java:', practiceTemplate: 'int result = 20 ___ 4;', practiceAnswer: '/', challenges: [
    ...
    { slug: 'java-1-4', title: 'Java String Class', exampleLanguage: 'java', exampleCode: 'String greeting = "Welcome";\nint len = greeting.length();', exampleExplanation: 'Strings are immutable objects in Java, providing methods like length(), concat(), and equals().', practiceInstruction: 'Retrieve string length:', practiceTemplate: 'int len = word.___ ();', practiceAnswer: 'length', challenges: [
    ...
    { slug: 'java-2-1', title: 'Branching (If)', exampleLanguage: 'java', exampleCode: 'int score = 85;\nif (score >= 70) {\n  System.out.println("Pass");\n}', exampleExplanation: 'Branching logic uses if statements. Code blocks are enclosed in curly braces {}.', practiceInstruction: 'Write the if conditional keyword:', practiceTemplate: '___ (x > 5) {}', practiceAnswer: 'if', challenges: [
    ...
    { slug: 'java-2-2', title: 'Switch Statements', exampleLanguage: 'java', exampleCode: 'int option = 2;\nswitch (option) {\n  case 1: System.out.println("One"); break;\n  case 2: System.out.println("Two"); break;\n}', exampleExplanation: 'Evaluates switch-case paths against a variable, exiting blocks using break statements.', practiceInstruction: 'Write the switch keyword:', practiceTemplate: '___ (code) { case 1: break; }', practiceAnswer: 'switch', challenges: [
    ...
    { slug: 'java-2-3', title: 'For Loop Iteration', exampleLanguage: 'java', exampleCode: 'for (int i = 0; i < 3; i++) {\n  System.out.println(i);\n}', exampleExplanation: 'Repeats code loops a set number of times. Includes initialization, condition, and update expressions.', practiceInstruction: 'Write the for loop keyword:', practiceTemplate: '___ (int i = 0; i < 5; i++) {}', practiceAnswer: 'for', challenges: [
    ...
    { slug: 'java-2-4', title: 'While & Do-While', exampleLanguage: 'java', exampleCode: 'int count = 0;\nwhile (count < 3) {\n  count++;\n}', exampleExplanation: 'do-while loops execute the loop body once before evaluating the loop condition at the end.', practiceInstruction: 'Write the while condition check:', practiceTemplate: '___ (count < 5) { count++; }', practiceAnswer: 'while', challenges: [
    ...
    { slug: 'java-3-1', title: 'Java Arrays', exampleLanguage: 'java', exampleCode: 'int[] nums = {10, 20, 30};\nSystem.out.println(nums[0]);', exampleExplanation: 'Arrays store fixed-size, homogeneous elements. Access uses 0-indexed bracket references.', practiceInstruction: 'Declare integer array type:', practiceTemplate: '___[] items = new int[5];', practiceAnswer: 'int', challenges: [
    ...
    { slug: 'java-3-2', title: 'Defining Methods', exampleLanguage: 'java', exampleCode: 'public static int add(int a, int b) {\n  return a + b;\n}', exampleExplanation: 'Declares reusable class functions (methods), specifying return types and parameters.', practiceInstruction: 'Define integer return type method:', practiceTemplate: 'public static ___ sum(int a, int b) { return a + b; }', practiceAnswer: 'int', challenges: [
    ...
    { slug: 'java-3-3', title: 'Return statement', exampleLanguage: 'java', exampleCode: 'public static double getPrice() {\n  return 19.99;\n}', exampleExplanation: 'Returns a calculated value to the method caller. The value must match the method return type.', practiceInstruction: 'Return double value:', practiceTemplate: 'public static double calculate() {\n  ___ 10.5;\n}', practiceAnswer: 'return', challenges: [
    ...
    { slug: 'java-3-4', title: 'Method Arguments', exampleLanguage: 'java', exampleCode: 'public static void greet(String name, int age) {\n  System.out.println(name);\n}', exampleExplanation: 'Passes parameters to methods by value, allowing variables to be evaluated inside methods.', practiceInstruction: 'Pass arguments to method:', practiceTemplate: 'public static void show(String ___ ) {}', practiceAnswer: 'msg', challenges: [
    ...
    { slug: 'java-4-1', title: 'Classes & Objects', exampleLanguage: 'java', exampleCode: 'class Product {}\nProduct p = new Product();', exampleExplanation: 'Classes serve as object blueprints. Objects are instantiated using the new keyword.', practiceInstruction: 'Instantiate class object:', practiceTemplate: 'Product p = ___ Product();', practiceAnswer: 'new', challenges: [
    ...
    { slug: 'java-4-2', title: 'Class Encapsulation', exampleLanguage: 'java', exampleCode: 'public class User {\n  private String name;\n  public String getName() { return name; }\n}', exampleExplanation: 'Encapsulation hides class variables using private modifiers, exposing access only via public getter/setter methods.', practiceInstruction: 'Expose private variable via getter:', practiceTemplate: 'public String ___ () { return name; }', practiceAnswer: 'getName', challenges: [
    ...
    { slug: 'java-4-3', title: 'Parameterized Constructors', exampleLanguage: 'java', exampleCode: 'public class User {\n  private String name;\n  public User(String name) {\n    this.name = name;\n  }\n}', exampleExplanation: 'Constructors initialize object fields on creation. Parameterized constructors customize default properties.', practiceInstruction: 'Initialize class instance name attribute:', practiceTemplate: 'public User(String name) {\n  this.name = ___;\n}', practiceAnswer: 'name', challenges: [
    ...
    { slug: 'java-4-4', title: 'Static variables', exampleLanguage: 'java', exampleCode: 'public class Counter {\n  public static int count = 0;\n}', exampleExplanation: 'Static fields belong to the class itself rather than object instances, sharing one copy among all instances.', practiceInstruction: 'Declare a class static variable:', practiceTemplate: 'public ___ int total = 0;', practiceAnswer: 'static', challenges: [
    ...
    { slug: 'java-5-1', title: 'OOP Inheritance', exampleLanguage: 'java', exampleCode: 'class Employee {}\nclass Manager extends Employee {}', exampleExplanation: 'Child classes inherit members from parent classes using the extends keyword.', practiceInstruction: 'Inherit from Employee:', practiceTemplate: 'class Manager ___ Employee {}', practiceAnswer: 'extends', challenges: [
    ...
    { slug: 'java-5-2', title: 'Calling super()', exampleLanguage: 'java', exampleCode: 'class Manager extends Employee {\n  public Manager() {\n    super();\n  }\n}', exampleExplanation: 'Invokes parent class constructors or methods from subclasses using the super keyword.', practiceInstruction: 'Call parent constructor:', practiceTemplate: 'public SubClass() {\n  ___ ();\n}', practiceAnswer: 'super', challenges: [
    ...
    { slug: 'java-5-3', title: 'Method Overriding', exampleLanguage: 'java', exampleCode: 'class Animal {\n  public void speak() {}\n}\nclass Dog extends Animal {\n  @Override\n  public void speak() {}\n}', exampleExplanation: 'Redefines parent methods in subclasses. Annotate with @Override to verify signatures during compilation.', practiceInstruction: 'Add override annotation:', practiceTemplate: '___ \npublic void run() {}', practiceAnswer: '@Override', challenges: [
    ...
    { slug: 'java-5-4', title: 'Java Interfaces', exampleLanguage: 'java', exampleCode: 'interface Printable {\n  void print();\n}\nclass Document implements Printable {\n  public void print() {}\n}', exampleExplanation: 'Interfaces define abstract method contracts. Classes implement these contracts using the implements keyword.', practiceInstruction: 'Implement interface Printable:', practiceTemplate: 'class Document ___ Printable {}', practiceAnswer: 'implements', challenges: [
    ...
    { slug: 'java-6-1', title: 'Java ArrayList', exampleLanguage: 'java', exampleCode: 'import java.util.ArrayList;\nArrayList<String> list = new ArrayList<>();\nlist.add("Java");', exampleExplanation: 'ArrayList provides dynamic, resizable array lists in Java. Part of the java.util collections framework.', practiceInstruction: 'Add item to ArrayList:', practiceTemplate: 'list.___ ("item");', practiceAnswer: 'add', challenges: [
    ...
    { slug: 'java-6-2', title: 'Java HashMap', exampleLanguage: 'java', exampleCode: 'import java.util.HashMap;\nHashMap<String, Integer> map = new HashMap<>();\nmap.put("Alice", 25);', exampleExplanation: 'HashMap stores data in key-value pairs, allowing fast lookups via keys.', practiceInstruction: 'Put key value in HashMap:', practiceTemplate: 'map.___ ("id", 101);', practiceAnswer: 'put', challenges: [
    ...
    { slug: 'java-6-3', title: 'Try Catch Blocks', exampleLanguage: 'java', exampleCode: 'try {\n  int x = 10 / 0;\n} catch (ArithmeticException e) {\n  System.out.println("Error");\n}', exampleExplanation: 'Try-catch blocks catch and handle runtime exceptions, preventing application crashes.', practiceInstruction: 'Catch runtime exceptions:', practiceTemplate: 'try {} ___ (Exception e) {}', practiceAnswer: 'catch', challenges: [
    ...
    { slug: 'java-6-4', title: 'Custom Exceptions', exampleLanguage: 'java', exampleCode: 'public class MyException extends Exception {\n  public MyException(String msg) { super(msg); }\n}', exampleExplanation: 'Creates custom exception classes by inheriting from the base Exception class.', practiceInstruction: 'Create custom Exception class:', practiceTemplate: 'public class InsufficientFundsException ___ Exception {}', practiceAnswer: 'extends', challenges: [
